...
<div class="container">
  <div class="row team">
    <div class="col-md-4 b1">
        <img class="img-responsive" src="<?php echo base_url(); ?>gudang/images/picTeam/picT1.png">
        <h4>Tom Simpson</h4>
        <h5>CEO</h5>
    ...
    <div class="col-md-4">
        <img class="img-responsive" src="<?php echo base_url(); ?>gudang/images/picTeam/picT2.png">
        <h4>John Doe</h4>
    ...
    <div class="col-md-4 b3">
        <img class="img-responsive" src="<?php echo base_url(); ?>gudang/images/picTeam/picT3.png">
        <h4>Anna White</h4>
        <h5>Developer</h5>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit<br/> quisque tempus ac eget diam et laoreet phasellus ut nisi id leo molestie. adipiscing vitae vel quam proin eget mauris eget.</p>
        <ul>
...
<div style="position: relative;">
  ...
  <div class="container">
    <div class="row about">
      <div class="col-md-6">
        <div class="about1">
        <img class="pic1Ab" src="<?php echo base_url(); ?>gudang/images/picAbout/aboutP1.png">
      ...
      <div class="col-md-6">
        <div class="about2">
        <img class="pic2Ab" src="<?php echo base_url(); ?>gudang/images/picAbout/aboutP2.png">
  ...
  <div class="container">
    <div class="row about">
      <div class="col-md-6">
        <div class="about1">
        <img class="pic1Ab" src="<?php echo base_url(); ?>gudang/images/picAbout/aboutP3.png">
      ...
      <div class="col-md-6">
        <div class="about2">
        <img class="pic2Ab" src="<?php echo base_url(); ?>gudang/images/picAbout/aboutP4.png">
