  ...
  <script type="text/javascript">
    jQuery(window).load(function(){
      items_set = [
        ...
        {category : 'branding', lika_count : '77', view_count : '234', src : 'gudang/images/prettyPhotoImages/pic9.jpg', title : 'Foil Mini Badges', content : '' },

        {category : 'polygraphy', lika_count : '45', view_count : '100', src : 'gudang/images/prettyPhotoImages/pic7.jpg', title : 'Darko – Business Card Mock Up', content : '' },

        {category : 'text_styles', lika_count : '22', view_count : '140', src : 'gudang/images/prettyPhotoImages/pic8.jpg', title : 'Woody Poster Text Effect', content : '' }
