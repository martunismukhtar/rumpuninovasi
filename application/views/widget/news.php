...
<div class="container">
    <div class="row news">
      ...
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news1.jpg"/>
      ...
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news2.jpg"/>
  ...
  <div class="container">
    <div class="row news2 news">
      <div class="col-md-6 text-left">
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news3.jpg"/>
      <h3><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
      <ul>
        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
      ...
      <div class="col-md-6 text-right">
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news4.jpg"/>
      <h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
      <ul>
        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
  ...
  <div class="container">
    <div class="row news2 news">
      <div class="col-md-6 text-left">
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news5.jpg"/>
      <h3 ><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
      <ul>
        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
      ...
      <div class="col-md-6 text-right">
      <img class="img-responsive picsGall" src="<?php echo base_url(); ?>gudang/images/picNews/news6.jpg"/>
      <h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
      <ul>
        <li><i class="fa fa-calendar"></i>April 25, 2014</li>
        <li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
