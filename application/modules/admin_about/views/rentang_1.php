...
<!--      <h1>
    ...
    <section class="content">
        ...
        <form role="form" id="form" novalidate="novalidate"  action="simpan-rentang.html" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <?php 
            $a=2;
            foreach($rentang_id->result() as $obf) {
                ...
                <div class="box box-info">
                    ...
                    <textarea id="editor'.$a.'" name="rentang-id[]" rows="10" cols="80">
                              '.$obf->deskripsi.'              
                    </textarea>
                    <input type="hidden" name="idrentang-id[]" value="'.$obf->id.'">
                </div>
        ...
        <div class="row">
            <?php 
            $b=6;
            if($rentang_en->num_rows()>0) {
                foreach($rentang_en->result() as $obfe) {
                    echo '<div class="col-md-3 dddrow">
                        <div class="box box-info">
                            <div class="box-header">
                            ...
                            <textarea id="editor'.$b.'" name="rentang-en[]" rows="10" cols="80">
                              '.$obfe->deskripsi.'              
                            </textarea>
                            <input type="hidden" name="idrentang-en[]" value="'.$obfe->id.'">
                        </div>
                    </div> ';
                    $b++;
                }
